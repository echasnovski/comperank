...
options(tibble.print_min = 6, tibble.print_max = 6, tibble.width = 120)
```
...
__Wide format__ is a more convenient way to store results with __fixed__ number of players in a game. Data should be organized in pairs of columns "player"-"score". Identifier of a pair should go after respective keyword and consist only from digits. For example: player1, score1, player2, score2. Order doesn't matter. Column `game` is optional.
